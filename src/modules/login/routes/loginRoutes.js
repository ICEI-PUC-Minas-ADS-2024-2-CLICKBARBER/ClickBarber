...
import {loginU} from "../controller/loginUControllers.js";
import {loginB} from "../controller/loginBControllers.js";
//pega a função que verifica se o token é válido
import {verifyToken , tokenHandler} from '../../utils/autenticateToken.js';

const routes = express.Router();

//rota que verifica o login
routes.get('/verify', verifyToken , tokenHandler)
